<?php $this->load->view('admin/public/header_view'); ?>
    ...
    <body>
        <div class="x-box">
            <div class="x-top">
                <i class="layui-icon x-login-close" style="display: none;">
                    &#x1007;
                </i>
                    ...
                    <form class="layui-form">
                        ...
                        <div class="layui-form-item x-login-box">
                            ...
                            <div class="layui-input-inline">
                                ...
                                autocomplete="off" placeholder="password" class="layui-input">
                            </div>
                        </div>
        ...
        <p style="color:#fff;text-align: center;">Copyright © 2017 </p>
        ...
        <script>
            ...
            function() {
                ...
                ,form = layui.form
                ,layer = layui.layer;
                $('body').css('background-color', '#393D49');
                ...
                form.on('submit(save)',
                function(data) {
                    $.post('/admin/login/do_login/',data.field,function(data) {
                      if(data.code == 1){
